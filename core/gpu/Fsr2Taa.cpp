...
// GLSL Compute Shader para FSR 2.x TAA (Temporal Anti-Aliasing)
/*
#version 460 core
...
layout(set = 0, binding = 5) uniform sampler2D prev_obj_id;        // Previous object ID
...
void main() {
    ...
    float blend_factor = push.temporal_alpha * accept * (1.0 - velocity_clamp * 0.5);
