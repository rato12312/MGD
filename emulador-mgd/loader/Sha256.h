...
// SHA-256 (FIPS-180): integridade de dumps e seções.
// Vetor NIST: "abc" -> ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad.
...
inline void block(const uint8_t* p, uint32_t h[8]) {
    uint32_t w[64];
    for (int i = 0; i < 16; i++) {
